...
<div class="modal-body">
    <form id="formAuditarRetrocesoEtapa" method='POST' class='ajaxForm' action="<?= site_url('fas/borrar_tramite_fas/' . $tramite->id .'/'. $requerimiento.'/'. $rut .'/'. $tipo ) ?>">
        <div class='validacion'></div>
        <label>Indique la razón por la cual elimina el beneficio:</label>
