		...
		xhttp.onreadystatechange = function() {
			...
			var days = [];
				...
				for (var i=0; i < sizeHistory; i ++){
					...
					if(i== 0)
						document.getElementById("rows").innerHTML += "<tr><td>"+ day + "-"+ month + "-" + date.getFullYear()+"</td><td>"+type+"</td><td><a class='btn btn-danger' href='#' ><i class='icon-white icon-trash'></i></a> </td></tr>";
					else
