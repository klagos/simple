...
<div id="main">
	...
	<div class="row">
	    <div class="span3">
			...
			<ul id="sideMenu" class="nav nav-list">
				<?php if($revisarLicencia): $cont_menu++; ?><li class="iniciar"><a href="#" onclick="Slide(['Licencia1','Licencia2','Licencia3','Licencia4'])">&nbsp;&nbsp;&nbsp;Licencias  <span style="font-size:20px;top:3px" class="pull-left hidden-xs showopacity glyphicon glyphicon-file"></span></a><?php endif ?>
				<?php if($revisarLicencia): ?><li class="<?= isset($sidebar) && $sidebar == 'agregar_licencia' ? 'active' : '' ?>"><a id="Licencia1" href="<?= site_url('tramites/iniciar/'.proceso_subsidio_id) ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agregar&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:33px" class="pull-center hidden-xs showopacity glyphicon glyphicon-plus"></a></li><?php endif ?>
			     	...
			     	<?php if($revisarLicencia): ?><li class="<?= isset($sidebar) && $sidebar == 'licencia' ? 'active' : '' ?>"><a id="Licencia3" href="<?= site_url('licencias/buscador') ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buscar&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:42px" class="pull-center hidden-xs  showopacity glyphicon glyphicon-search"></a></li><?php endif ?>
			     	<?php if($revisarLicencia): ?><li class="<?= isset($sidebar) && $sidebar == 'licencia_pago' ? 'active' : '' ?>"><a id="Licencia4" href="<?= site_url('licencias/pago') ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pago&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:52px" class="pull-center hidden-xs showopacity glyphicon glyphicon-briefcase"></a></li><?php endif ?>
			</ul>
