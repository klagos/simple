...
<div id="main">
	...
	<div class="row">
	    <div class="span3">
			...
			//Modulo trabajadores
			$trabajadores =Doctrine::getTable('GrupoUsuarios')->cantGruposUsuaros(UsuarioSesion::usuario()->id,"MODULO_TRABAJADORES");
		 ...
		 <?php if($revisarLicencia): ?><li class="<?= isset($sidebar) && $sidebar == 'agregar_licencia' ? 'active' : '' ?>"><a id="Licencia1" href="<?= site_url('tramites/iniciar/'.proceso_subsidio_id) ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agregar Licencia&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:33px" class="pull-center hidden-xs showopacity glyphicon glyphicon-plus"></a></li><?php endif ?>
			     	...
			     	<?php if($revisarLicencia>1): ?><li class="<?= isset($sidebar) && $sidebar == 'editar_masiva' ? 'active' : '' ?>"><a id="Licencia4" href="<?= site_url('tramites/iniciar/'.proceso_editar_masiva_id) ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edición Masiva&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;" class="pull-center hidden-xs showopacity glyphicon glyphicon-edit"></a></li><?php endif ?>
				<?php if($revisarLicencia): ?><li class="<?= isset($sidebar) && $sidebar == 'licencia' ? 'active' : '' ?>"><a id="Licencia5" href="<?= site_url('licencias/buscador_new') ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buscar&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:42px" class="pull-center hidden-xs  showopacity glyphicon glyphicon-search"></a></li><?php endif ?>
			     	<?php if($revisarLicencia>1): ?><li class="<?= isset($sidebar) && $sidebar == 'licencia_pago' ? 'active' : '' ?>"><a id="Licencia6" href="<?= site_url('licencias/pago') ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pago&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:52px" class="pull-center hidden-xs showopacity glyphicon glyphicon-briefcase"></a></li><?php endif ?>
			<?php if($revisarLicencia>1): ?><li class="<?= isset($sidebar) && $sidebar == 'licencia_reporte' ? 'active' : '' ?>"><a id="Licencia7" href="<?= site_url('licencias/reporte') ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reporte&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:52px" class="pull-center hidden-xs showopacity glyphicon glyphicon-download-alt"></a></li><?php endif ?>
...
op:8px" class="pull-left hidden-xs showopacity glyphicon glyphicon-th-large"></span></a></li><?php endif ?>
			...
			<!--REPORT-->
          		 <?php if($trabajadores): ?><li class="<?= isset($sidebar) && $sidebar == 'trabajadores_report' ? 'active' : '' ?>"><a id="trabajadores_report" href="<?= site_url('trabajadores/reporte') ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reporte&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:52px" class="pull-center hidden-xs showopacity glyphicon glyphicon-download-alt"></a></li><?php endif ?>
			 ...
			 <!-- MODULO FAS -->
                        <ul id="sideMenu" class="nav nav-list">
                           ...
                           <?php if($fas==2): ?><li class="<?= isset($sidebar) && $sidebar == 'fas_add_medico' ? 'active' : '' ?>"><a id="fas_add_medico" href="<?= site_url('tramites/iniciar/'. proceso_fas_medicos) ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Beneficio Medico&nbsp;&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:28px" class="pull-ccenter hidden-xs showopacity glyphicon glyphicon-plus"></a></li><?php endif ?>
			<?php if($fas==2): ?><li class="<?= isset($sidebar) && $sidebar == 'fas_add_medico' ? 'active' : '' ?>"><a id="fas_add_medico" href="<?= site_url('tramites/iniciar/'. proceso_fas_social) ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Beneficio Social&nbsp;&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:28px" class="pull-ccenter hidden-xs showopacity glyphicon glyphicon-plus"></a></li><?php endif ?>
			
			<?php if($fas==2): ?><li class="<?= isset($sidebar) && $sidebar == 'fas_add_admin' ? 'active' : '' ?>"><a id="fas_add_admin" href="<?= site_url('tramites/iniciar/'. proceso_fas_guardar_convenio_medico) ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agregar Persona&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:13px;top:3px;left:28px" class="pull-ccenter hidden-xs showopacity glyphicon glyphicon-asterisk"></a></li><?php endif ?>
			...
			<?php if($fas==2): ?><li class="<?= isset($sidebar) && $sidebar == 'fas_consolidado' ? 'active' : '' ?>"><a id="fas_consolidado" href="<?= site_url('fas/consolidado') ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Consolidado&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <span style="font-size:13px;top:3px;left:28px" class="pull-ccenter hidden-xs showopacity glyphicon glyphicon-briefcase"></a></li><?php endif ?>
